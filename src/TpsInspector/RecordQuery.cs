...
internal static class RecordQuery
{
    ...
    private sealed class ResolvedPredicate
    {
        ...
        private readonly bool _trimFixedString;
            ...
            bool trimFixedString)
        {
            ...
            _trimFixedString = trimFixedString;
        }
        ...
        public static ResolvedPredicate Create(TpsTable table, PredicateInput input, bool caseSensitive)
        {
            ...
            if (column.Field is not null)
            {
                ...
                return new ResolvedPredicate(
                    ...
                    literal,
                    caseSensitive,
                    trimFixedString: field.Type == TpsFieldType.String);
            }
        ...
        public bool Matches(TpsRecord record)
        {
            ...
            if (_type is TpsFieldType.String or TpsFieldType.CString or TpsFieldType.PString or TpsFieldType.Memo)
            {
        ...
        private int Compare(object actual, object expected) => _type switch
        {
            ...
            TpsFieldType.Group => ((byte[])actual).AsSpan().SequenceCompareTo((byte[])expected),
            ...
            string fieldName)
        {
            ...
            try
            {
                return type switch
                {
                    ...
                    TpsFieldType.String or TpsFieldType.CString or TpsFieldType.PString or TpsFieldType.Memo => literal,
                    TpsFieldType.Group => ParseHex(literal),
        ...
        private static byte[] ParseHex(string literal)
        {
            ...
            return Convert.FromHexString(literal[2..]);
        }
        ...
        private static IReadOnlySet<PredicateOperator> OperatorsFor(TpsFieldType type) => type switch
        {
            ...
            TpsFieldType.String or TpsFieldType.CString or TpsFieldType.PString or TpsFieldType.Memo => TextOperators,
            TpsFieldType.Group => EqualityOperators,
        ...
        private static readonly IReadOnlySet<PredicateOperator> EqualityOperators =
